...
from sources.openfibsem.fibsem_liftout_v1.geometry.oracle import GeometryOracle
...
def test_real_openfibsem_runtime_import_reports_pinned_source() -> None:
    from sources.openfibsem.fibsem_liftout_v1.backend import openfibsem_source_commit

    assert openfibsem_source_commit() == PINNED


def test_openfibsem_runtime_uses_headless_ray_tracing() -> None:
    from sources.openfibsem.fibsem_liftout_v1.backend import _OpenFibsemRuntime
