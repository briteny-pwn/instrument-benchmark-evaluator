...
from sources.pyvisa.pyvisa_dut_validation_v1.scoring import grade_run
...
from sources.pyvisa.pyvisa_dut_validation_v2.service import run_service
...
INSTANCE_PACKAGE = ROOT.parent / "instance" / "sources" / "pyvisa" / "pyvisa_dut_validation_v2"
REFERENCE = ROOT / "sources" / "pyvisa" / "pyvisa_dut_validation_v2" / "reference" / "solution.py"
SIMULATOR = ROOT / "sources" / "pyvisa" / "pyvisa_dut_validation_v2" / "simulator.yaml"
...
BAD_PROTOCOL = (
    ROOT / "sources" / "pyvisa" / "pyvisa_dut_validation_v2" / "negatives" / "bad_protocol.py"
)
LEAKED_SESSIONS = (
    ROOT
    / "sources"
